...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "renloi.ipc", false, filepath.Join(os.TempDir(), "renloi.ipc")},
		{"data", "renloi.ipc", false, "data/renloi.ipc"},
		{"data", "./renloi.ipc", false, "./renloi.ipc"},
		{"data", "/renloi.ipc", false, "/renloi.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "renloi.ipc", true, `\\.\pipe\renloi.ipc`},
		{"data", "renloi.ipc", true, `\\.\pipe\renloi.ipc`},
		{"data", `\\.\pipe\renloi.ipc`, true, `\\.\pipe\renloi.ipc`},
	}
