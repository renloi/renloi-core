Name "renloi ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/renloi/renloi-core/issues"
!define UPDATEURL "https://github.com/renloi/renloi-core/releases"
!define ABOUTURL "https://github.com/renloi/renloi-core#ethereum-go"
...
# Install renloi binary
Section "Renloi" RENLOI_IDX
  SetOutPath $INSTDIR
  file {{.Renloi}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\renloi.exe"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\renloi.exe" "attach"
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe"

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Renloi incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Renloi outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Renloi UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Renloi incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\renloi.exe" "" "" "Ethereum" 30303 "" "" ""
  SimpleFC::AdvAddRule "Renloi outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\renloi.exe" "" "" "Ethereum" "" 30303 "" ""
  SimpleFC::AdvAddRule "Renloi UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\renloi.exe" "" "" "Ethereum" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\renloi.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\renloi.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${RENLOI_IDX}
    SectionGetSize ${RENLOI_IDX} $0
