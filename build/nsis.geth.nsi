...
# 1. install renloi for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for renloi
# 5. create renloi, attach and uninstall start menu entries
...
function .onInit
  # make vars are global for all users since renloi is installed global
