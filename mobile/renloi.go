...
// NodeConfig represents the collection of configuration values to fine tune the Renloi
...
// Node represents a Renloi Ethereum node instance.
type Node struct {
	node *node.Node
}

// NewNode creates and configures a new Renloi node.
