...
import (
	...
	"github.com/renloi/renloi-core/consensus/congress"
	"github.com/renloi/renloi-core/core"
	"github.com/renloi/renloi-core/core/bloombits"
	"github.com/renloi/renloi-core/core/rawdb"
	"github.com/renloi/renloi-core/core/state/pruner"
	...
	"github.com/renloi/renloi-core/eth/filters"
	"github.com/renloi/renloi-core/eth/gasprice"
	"github.com/renloi/renloi-core/eth/protocols/eth"
	"github.com/renloi/renloi-core/eth/protocols/snap"
	...
	"github.com/renloi/renloi-core/p2p/dnsdisc"
...
func New(stack *node.Node, config *ethconfig.Config) (*Ethereum, error) {
	...
	eth.posa, eth.isDPoS = eth.engine.(consensus.DPoS)
	...
	if !config.SkipBcVersionCheck {
		if bcVersion != nil && *bcVersion > core.BlockChainVersion {
			return nil, fmt.Errorf("database version is v%d, Renloi %s only supports v%d", *bcVersion, params.VersionWithMeta, core.BlockChainVersion)
