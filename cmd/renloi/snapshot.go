		...
		Subcommands: []cli.Command{
			{
				...
				Description: `
renloi snapshot prune-state <state-root>
...
during the use of Renloi, please also specify it here for correct deletion. Otherwise
...
`,
			...
			{
				Name:      "dump",
				Usage:     "Dump a specific block from storage (same as 'renloi dump' but using snapshots)",
				...
				Description: `
This command is semantically equivalent to 'renloi dump', but uses the snapshots
