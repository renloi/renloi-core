...
import (
	...
	"github.com/renloi/renloi-core/accounts/external"
	"github.com/renloi/renloi-core/accounts/keystore"
	"github.com/renloi/renloi-core/accounts/scwallet"
	"github.com/renloi/renloi-core/accounts/usbwallet"
	"github.com/renloi/renloi-core/cmd/utils"
	"github.com/renloi/renloi-core/eth/catalyst"
...
func loadConfig(file string, cfg *renloiConfig) error {
	f, err := os.Open(file)
	if err != nil {
		return err
	}
...
func defaultNodeConfig() node.Config {
	...
	cfg.IPCPath = "renloi.ipc"
	return cfg
}

// makeConfigNode loads renloi configuration and creates a blank node instance.
func makeConfigNode(ctx *cli.Context) (*node.Node, renloiConfig) {
	// Load defaults.
	cfg := renloiConfig{
...
// makeFullNode loads renloi configuration and creates the Ethereum backend.
...
func applyMetricConfig(ctx *cli.Context, cfg *renloiConfig) {
