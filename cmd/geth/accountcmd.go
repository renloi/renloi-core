...
var (
	walletCommand = cli.Command{
		...
		Description: `
    renloi wallet import /path/to/my/presale.wallet
		...
		Subcommands: []cli.Command{
			{
				...
				Description: `
	renloi wallet [options] /path/to/my/presale.wallet
...
For non-interactive use the password can be specified with the --password flag:
    ...
    renloi account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    renloi account import [options] <keyfile>
...
func accountCreate(ctx *cli.Context) error {
	cfg := renloiConfig{Node: defaultNodeConfig()}
	// Load config file.
