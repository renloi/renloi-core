...
import (
	...
	"github.com/renloi/renloi-core/accounts"
	"github.com/renloi/renloi-core/accounts/keystore"
	"github.com/renloi/renloi-core/common"
	"github.com/renloi/renloi-core/common/fdlimit"
	"github.com/renloi/renloi-core/consensus"
	"github.com/renloi/renloi-core/consensus/clique"
	"github.com/renloi/renloi-core/consensus/ethash"
	...
	"github.com/renloi/renloi-core/eth/downloader"
	"github.com/renloi/renloi-core/eth/ethconfig"
	"github.com/renloi/renloi-core/eth/gasprice"
	"github.com/renloi/renloi-core/eth/tracers"
	"github.com/renloi/renloi-core/ethdb"
	"github.com/renloi/renloi-core/ethstats"
	"github.com/renloi/renloi-core/graphql"
	"github.com/renloi/renloi-core/internal/ethapi"
	"github.com/renloi/renloi-core/internal/flags"
	"github.com/renloi/renloi-core/les"
	"github.com/renloi/renloi-core/log"
	"github.com/renloi/renloi-core/metrics"
	"github.com/renloi/renloi-core/metrics/exp"
	"github.com/renloi/renloi-core/metrics/influxdb"
	"github.com/renloi/renloi-core/miner"
	"github.com/renloi/renloi-core/node"
	"github.com/renloi/renloi-core/p2p"
	"github.com/renloi/renloi-core/p2p/enode"
	"github.com/renloi/renloi-core/p2p/nat"
	"github.com/renloi/renloi-core/p2p/netutil"
...
// for Renloi and returns half of the allowance to assign to the database.
...
func MakeAddress(ks *keystore.KeyStore, account string) (accounts.Account, error) {
	...
	log.Warn("Please use explicit addresses! (can search via `renloi account list`)")
	log.Warn("-------------------------------------------------------------------")
...
func SetupMetrics(ctx *cli.Context) {
	if metrics.Enabled {
		...
		if enableExport {
			...
			go influxdb.InfluxDBWithTags(metrics.DefaultRegistry, 10*time.Second, endpoint, database, username, password, "renloi.", tagsMap)
		} else if enableExportV2 {
			tagsMap := SplitTagsFlag(ctx.GlobalString(MetricsInfluxDBTagsFlag.Name))

			log.Info("Enabling metrics export to InfluxDB (v2)")

			go influxdb.InfluxDBV2WithTags(metrics.DefaultRegistry, 10*time.Second, endpoint, token, bucket, organization, "renloi.", tagsMap)
		}
...
// new format.
//
// e.g. renloi account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this method with:
//
// renloi --keystore /tmp/mykeystore --lightkdf account new
//
