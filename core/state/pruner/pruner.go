...
pruning. Remember don't start the Renloi without deleting the clean trie cache
otherwise the entire database may be damaged!

Check the command description "renloi snapshot prune-state --help" for more details.
`
